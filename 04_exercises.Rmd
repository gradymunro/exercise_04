...
starbucks_us_locations %>% 
  ...
  expand_limits(x = states_map$long - 2, 
                y = states_map$lat) + 
  labs(title = "Map of Starbucks Locations in the Lower 48, with States Coloured by the Number of Starbucks 
       per 10,000 people",
       fill = "Starbucks per 
10,000 People") +
  theme_map()
...
leaflet(data = Station_Num) %>% 
  ...
  addLegend(position = "topleft",
            ...
            opacity = 1,
            title = "Departures From Each Station")
```
...
leaflet(data = Station_Proportion) %>% 
  ...
  addLegend(position = "topleft",
            ...
            opacity = 1,
            title = "Proportion of Departures by Casual Riders")
```
...
leaflet(mpls_all) %>% 
  ...
  addLegend(position = "topleft",
            ...
            opacity = 0.7,
            title = "Proportion of Stops that are Suspicious")
```
